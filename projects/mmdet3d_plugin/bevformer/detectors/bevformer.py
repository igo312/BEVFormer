...
class BEVFormer(MVXTwoStageDetector):
    ...
    def simple_test(self, img_metas, img=None, prev_bev=None, rescale=False):
        ...
        # new_prev_bev = self.simple_test_pts(
        ...
        for pts_bbox in bbox_pts:
            boxes_3d.append(pts_bbox['boxes_3d'])
            scores_3d.append(pts_bbox['scores_3d'])
            labels_3d.append(pts_bbox['labels_3d'])
        return new_prev_bev, [torch.stack(boxes_3d), torch.stack(scores_3d), torch.stack(labels_3d)]


@DETECTORS.register_module()
class BEVFormer_bak(MVXTwoStageDetector):
    """BEVFormer.
    Args:
        video_test_mode (bool): Decide whether to use temporal information during inference.
    """
